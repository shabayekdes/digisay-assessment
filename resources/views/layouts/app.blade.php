...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="#" class="d-block">Esmail Shabayek</a>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2021 <a href="https://shabayekdes.netlify.app/">Esmail Shabayek</a>.</strong>
            All rights reserved.
